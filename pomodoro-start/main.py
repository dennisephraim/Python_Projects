...
def count_down(count):
    ...
    if count >= 0:
        ...
        if reps % 2 == 0:
            ...
            checkmark_lb.config(text= checkmarks)
...
title_lb = Label(text="Timer", font=(FONT_NAME, 40), fg=GREEN, bg=YELLOW)
title_lb.grid(row=0, column=1)

checkmark_lb = Label(fg=GREEN, bg=YELLOW)
checkmark_lb.grid(row=3, column=1)
